...
local TELEPORT_HANDLER_SCRIPT = CONS_INFO.GetReadyLoadText(CONS_INFO.URLS.TELEPORT_HANDLER_URL)
--local TELEPORT_HANDLER_SCRIPT = game:HttpGet("https://raw.githubusercontent.com/user29031203/LegendZero/refs/heads/main/tests/webloader-tester.lua")

print(TELEPORT_HANDLER_SCRIPT)
pcall(TeleportQueue, TELEPORT_HANDLER_SCRIPT)
print("OK")